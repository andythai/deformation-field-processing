...
| `crops_3d/` | the four 24³ B0039 crops of the 3D windowed port (`twist`, `cluster`, `sliver`, `moderate`) plus `sub20.npy`, the 20³ = 8000-voxel cut the phase-3 window cap was measured on | `python benchmarks/make_hard_crops_3d.py --build-only`; `python benchmarks/windowed_3d_sweep.py --cut-sub20` |
